...
<html lang="en">
    ...
    <body id="page-top" >//style="background-color: black"
        ...
        <header class="masthead" style="  background-image: url(<?php echo $main->bc_img;?>)">
            <div class="container">
            <div style="color: yellow" class="masthead-subheading">{{$main->sub_title}}</div>
            <div style="color: yellow" class="masthead-heading text-uppercase">{{$main->title}}</div>
            <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{url($main->cv)}}">Resume</a>
            </div>
        </header>
        <!-- Services-->
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">{{$portfolio->clint}}</div>
        ...
        <section class="page-section" id="contact">
            ...
            <form id="contactForm" method="post" action="{{route('contact.store')}}">
                ...
                <div class="row align-items-stretch mb-5">
                    ...
                    <div class="text-center">
                        <div id="success" > @include('alert.massages')</div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <img class="img-fluid d-block mx-auto" src="{{url($portfolio->sub_image)}}" alt="" />
                                <p>{{$portfolio->description}}</p>
                                    <ul class="list-inline">
                                        <li>Date: {{$portfolio->created_at->toDateString()}}
                                        </li>
                                    <li>{{$portfolio->clint }}</li>
